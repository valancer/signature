        ...
        imgLiquid: function(options) {
            ...
            return this.each(function($i) {
                ...
                $img.css({
                    ...
                    height: "auto",
                    display: "block",
                    "image-rendering": settings.imageRendering
                });
                ...
                if (isIE && settings.imageRendering === "optimizeQuality") {
                ...
                if (settings.useCssAligns) {
                    ...
                    if (cha === "left" || cha === "center" || cha === "right") {
                        settings.horizontalAlign = cha
                    }
                    if (cva === "top" || cva === "middle" || cva === "bottom" || cva === "center") {
                        settings.verticalAlign = cva
                    }
                }
                if (settings.useDataHtmlAttr) {
                    if ($imgBoxCont.attr("data-imgLiquid-fill") === "true") {
                        settings.fill = true
                    }
                    if ($imgBoxCont.attr("data-imgLiquid-fill") === "false") {
                        settings.fill = false
                    }
                    if ($imgBoxCont.attr("data-imgLiquid-responsive") === "true") {
                        settings.responsive = true
                    }
                    if ($imgBoxCont.attr("data-imgLiquid-responsive") === "false") {
                        settings.responsive = false
                    }
                    if (Number($imgBoxCont.attr("data-imgLiquid-fadeInTime")) > 0) {
                        settings.fadeInTime = Number($imgBoxCont.attr("data-imgLiquid-fadeInTime"))
                    }
                    ...
                    if (ha === "left" || ha === "center" || ha === "right") {
                        settings.horizontalAlign = ha
                    }
                    if (va === "top" || va === "middle" || va === "bottom" || va === "center") {
                        settings.verticalAlign = va
                    }
                }
                ...
                function checkElementSizeDelay() {
                    ...
                    if ($imgBoxCont.actualSize !== $imgBoxCont.sizeOld) {
                        if ($img.data("ILprocessed") && $imgBoxCont.sizeOld !== undefined) {
                            if (settings.onItemResize) {
                                settings.onItemResize($i, $imgBoxCont, $img)
                            }
                ...
                if (settings.responsive) {
                    settings.hardPixels = true
                }
                if (settings.responsive || settings.onItemResize !== null) {
                    checkElementSize()
                }
